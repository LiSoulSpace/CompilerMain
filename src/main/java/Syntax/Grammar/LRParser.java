...
import semantic.grammar.TreeNode;
...
public class LRParser {
	...
	public static final String LOGFILE_NAME = USER_DIR + "/src/main/resources/result/LR1_Grammar_Analyze.log";
	...
	public boolean parse(List<Token> inputTokens,grammar grammarTree) throws IOException {
		if(grammarTree==null){
