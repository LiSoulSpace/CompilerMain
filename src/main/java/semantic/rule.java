            ...
            switch (item.left.TAG) {
                ...
                case "S" -> {
                    if (equal(item.right, new String[]{Tag.ID, Operator.ASSIGN, "E", Operator.LNND})) {
                        ...
                        code = childs.get(2).getValue("code") +
                                childs.get(2).getValue("true")
                        ...
                        code = childs.get(2).getValue("code")
                                ...
                                + childs.get(5).getValue("code")
                                + "goto " + next
                                + childs.get(2).getValue("false")
                                + childs.get(9).getValue("code");
                        ...
                        code = root + childs.get(2).getValue("code") +
                                childs.get(2).getValue("true")
                                + childs.get(5).getValue("code") +
                                "goto " + root +
                                childs.get(2).getValue("false");
